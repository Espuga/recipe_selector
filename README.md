...
## Overview
This repository contains a recipe selection demo powered by embeddings. It loads recipes from MongoDB, generates embeddings with `sentence-transformers`, classifies a Catalan prompt, and learns from feedback to recalculate recipe centroids.
...
- `AGENTS.md`: guide for agents and contributors with structure and flow details.
