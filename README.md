...
## Visió general
Aquest repositori conté una demo de selecció de receptes basada en embeddings. Carrega receptes des de MongoDB, genera embeddings amb `sentence-transformers`, classifica un prompt en català i aprèn del feedback per recalcular centroides de receptes.
...
- `AGENTS.md`: guia per agents i contribuïdors amb el detall de l'estructura i fluxos.
